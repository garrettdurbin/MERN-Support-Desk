    ...
    <>
      ...
      <section className="form">
        <div className="form-group">
          ...
          <input
            type="text" className="form-control" value={name} disabled
          />
        </div>
        <div className="form-group">
        ...
        <form onSubmit={onSubmit}>
          <div className="form-group">
            ...
            <select
              name="product" id="product" value={product} onChange={(e) => setProduct(e.target.value)}
            >
          ...
          <div className="form-group">
            <buttom className="btn btn-block">Submit</buttom>
          </div>
        </form>
      </section>
    </>
